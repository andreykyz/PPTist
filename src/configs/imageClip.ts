...
const clipNames: Record<string, string> = {
  rect: t('clipShape.rect'),
  snip1Rect: t('clipShape.snip1Rect'),
  snip2DiagRect: t('clipShape.snip2DiagRect'),
  roundRect: t('clipShape.roundRect'),
  ellipse: t('clipShape.ellipse'),
  triangle: t('clipShape.triangle'),
  rtTriangle: t('clipShape.rtTriangle'),
  triangleReverse: t('clipShape.triangleReverse'),
  diamond: t('clipShape.diamond'),
  pentagon: t('clipShape.pentagon'),
  hexagon: t('clipShape.hexagon'),
  heptagon: t('clipShape.heptagon'),
  octagon: t('clipShape.octagon'),
  chevron: t('clipShape.chevron'),
  homePlate: t('clipShape.homePlate'),
  rightArrow: t('clipShape.rightArrow'),
  parallelogram: t('clipShape.parallelogram'),
  parallelogramReverse: t('clipShape.parallelogramReverse'),
  trapezoid: t('clipShape.trapezoid'),
  trapezoidReverse: t('clipShape.trapezoidReverse'),
}
...
export const CLIPPATHS: ClipPath = {
  ...
  triangleReverse: {
    name: clipNames.triangleReverse,
    type: ClipPathTypes.POLYGON,
  ...
  parallelogramReverse: {
    name: clipNames.parallelogramReverse,
    type: ClipPathTypes.POLYGON,
  ...
  trapezoidReverse: {
    name: clipNames.trapezoidReverse,
    type: ClipPathTypes.POLYGON,

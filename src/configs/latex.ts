...
export const FORMULA_LIST = [
  {
    label: t('latexConfig.formula.gauss'),
...
export const SYMBOL_LIST = [
  {
    type: 'operators',
    label: t('latexConfig.category.math'),
    children: [
      { latex: '\\cdot' },
      { latex: '\\pm' },
      { latex: '\\mp' },
  ...
  {
    type: 'group',
    label: t('latexConfig.category.group'),
    children: [
      { latex: '\\frac{a}{b}' },
      { latex: '\\frac{dx}{dx}' },
  ...
  {
    type: 'verbatim',
    label: t('latexConfig.category.function'),
    children: [
      { latex: '\\log' },
      { latex: '\\ln' },
      { latex: '\\exp' },
  ...
  {
    type: 'greek',
    label: t('latexConfig.category.greek'),
    children: [
      { latex: '\\alpha' },
      { latex: '\\beta' },
      { latex: '\\gamma' },

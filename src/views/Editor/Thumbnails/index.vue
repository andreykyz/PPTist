<template>
  ...
  >
    <div class="add-slide">
      <div class="btn" @click="createSlide()"><i-icon-park-outline:plus class="icon" />{{ t('elementMessage.addSlide') }}</div>
        ...
        <div class="thumbnail-container">
          ...
          >
            ...
            <span class="text" v-else>
              <div class="text-content">{{ element?.sectionTag ? (element?.sectionTag?.title || t('thumbnailSection.untitled')) : t('thumbnailSection.defaultName') }}</div>
            </span>
          </div>
          <div
    ...
    <div class="page-number">{{ t('elementMessage.slideNumberLabel') }} {{slideIndex + 1}} / {{slides.length}}</div>
  </div>
</template>
...
const contextmenusSection = (el: HTMLElement): ContextmenuItem[] => {
  ...
  return [
    {
      text: t('contextMenu.deleteSubject'),
      handler: () => removeSection(sectionId),
    },
    {
      text: t('contextMenu.deleteSectionSlides'),
      handler: () => {
        mainStore.setActiveElementIdList([])
    ...
    {
      text: t('contextMenu.renameSubject'),
...
const contextmenusThumbnailItem = (): ContextmenuItem[] => {
  return [
    ...
    {
      text: t('contextMenu.copyPage'),
      subText: 'Ctrl + D',
      handler: copyAndPasteSlide,
    },
    {
      text: t('contextMenu.deletePage'),
      subText: 'Delete',
      handler: () => deleteSlide(),
    },
    {
      text: t('contextMenu.addSubject'),

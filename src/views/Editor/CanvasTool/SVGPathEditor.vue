<template>
  <div class="svg-path-editor">
    <div class="container">
      ...
      <div class="svg-panel">
        <div class="panel-section">
          ...
          >
            <RadioButton value="L" :disabled="activePointIndex === 0">{{ t('svgPath.line') }}</RadioButton>
            <RadioButton value="Q" :disabled="activePointIndex === 0">{{ t('svgPath.quadratic') }}</RadioButton>
            <RadioButton value="C" :disabled="activePointIndex === 0">{{ t('svgPath.cubic') }}</RadioButton>
            <RadioButton value="A" :disabled="activePointIndex === 0">{{ t('svgPath.arc') }}</RadioButton>
          </RadioGroup>
        </div>
        ...
        <div class="panel-section">
          <div class="section-title">{{ t('svgPath.coordinates') }}</div>
          <div class="input-row">
            <NumberInput
              class="number-input"
              :min="CANVAS_MIN"
              ...
              >
                <template #prefix>{{ t('svgPath.horizontal') }}</template>
              </NumberInput>
              <NumberInput
                class="number-input"
                :min="CANVAS_MIN"
              ...
              >
                <template #prefix>{{ t('svgPath.vertical') }}</template>
            </NumberInput>
          </div>
        </div>
        ...
        <template v-if="activePoint.q">
          <Divider :margin="20" />
          <div class="panel-section">
            <div class="section-title">{{ t('svgPath.controlPoint') }}</div>
            <div class="input-row">
              <NumberInput
                class="number-input"
                :min="CANVAS_MIN"
        ...
        <template v-if="activePoint.c">
          ...
          <div class="panel-section">
            ...
            <div class="input-row">
              ...
              >
                <template #prefix>{{ t('svgPath.controlPoint1H') }}</template>
              </NumberInput>
              <NumberInput
                class="number-input"
                :min="CANVAS_MIN"
              ...
              >
                <template #prefix>{{ t('svgPath.controlPoint1V') }}</template>
              </NumberInput>
            </div>
            <div class="input-row">
              <NumberInput
              ...
              >
                <template #prefix>{{ t('svgPath.controlPoint2H') }}</template>
              </NumberInput>
              <NumberInput
                class="number-input"
                :min="CANVAS_MIN"
              ...
              >
                <template #prefix>{{ t('svgPath.controlPoint2V') }}</template>
              </NumberInput>
            </div>
          </div>
        </template>
        ...
        <template v-if="activePoint.a">
          <Divider :margin="20" />
          <div class="panel-section">
            <div class="section-title">{{ t('svgPath.arcSettings') }}</div>
            <div class="input-row">
              <NumberInput
                class="number-input"
                :min="0"
              ...
              >
                <template #prefix>{{ t('svgPath.radiusH') }}</template>
              </NumberInput>
              <NumberInput
                class="number-input"
                :min="0"
              ...
              >
                <template #prefix>{{ t('svgPath.radiusV') }}</template>
              </NumberInput>
            </div>
            <div class="input-row">
              <NumberInput
              ...
              >
                <template #prefix>{{ t('svgPath.rotation') }}</template>
              </NumberInput>
            </div>
            <div class="checkbox-row">
              <Checkbox :value="activePoint.a.laf === 1" @update:value="value => updateArcParam('laf', value ? 1 : 0)">{{ t('svgPath.largeArc') }}</Checkbox>
              <Checkbox :value="activePoint.a.sf === 1" @update:value="value => updateArcParam('sf', value ? 1 : 0)">{{ t('svgPath.sweep') }}</Checkbox>
            </div>
          </div>
        </template>
        ...
        <div class="panel-section">
          <Checkbox :value="closePath" @update:value="value => closePath = value">{{ t('svgPath.closePath') }}</Checkbox>
        </div>
    ...
    <div class="footer">
      <div class="tooltips">{{ t('svgPath.tips') }}</div>
      <div class="footer-actions">
        <Button @click="emit('close')">{{ t('generic.close') }}</Button>
        <Button type="primary" :disabled="!canInsert" @click="insert()">{{ t('generic.confirm') }}</Button>
      </div>
    </div>
  </div>
</template>
...
const contextmenus = (): ContextmenuItem[] => {
  return [
    {
      text: t('svgPath.contextmenu.addLine'),
      handler: () => addPoint('L'),
    },
    {
      text: t('svgPath.contextmenu.addQuadratic'),
      handler: () => addPoint('Q'),
    },
    {
      text: t('svgPath.contextmenu.addCubic'),
      handler: () => addPoint('C'),
    },
    {
      text: t('svgPath.contextmenu.addArc'),
      handler: () => addPoint('A'),
    },
    { divider: true },
    {
      text: t('svgPath.contextmenu.deletePoint'),

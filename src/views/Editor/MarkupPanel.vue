<template>
  ...
  >
    <div class="container">
      <div class="row">
        <div style="width: 40%;">{{ t('markup.slideType') }}</div>
        <Select
          style="width: 60%;"
          :value="slideType"
      ...
      <div class="row" v-if="handleElement && (handleElement.type === 'text' || (handleElement.type === 'shape' && handleElement.text))">
        <div style="width: 40%;">{{ t('markup.textType') }}</div>
        <Select
          style="width: 60%;"
          :value="textType"
      ...
      <div class="row" v-else-if="handleElement && handleElement.type === 'image'">
        <div style="width: 40%;">{{ t('markup.imageType') }}</div>
        <Select
          style="width: 60%;"
          :value="imageType"
...
const slideTypeOptions = ref<{ label: string; value: SlideType | '' }[]>([
  { label: t('markup.slideTypes.unlabeled'), value: '' },
  { label: t('markup.slideTypes.cover'), value: 'cover' },
  { label: t('markup.slideTypes.contents'), value: 'contents' },
  { label: t('markup.slideTypes.transition'), value: 'transition' },
  { label: t('markup.slideTypes.content'), value: 'content' },
  { label: t('markup.slideTypes.end'), value: 'end' },
])

const textTypeOptions = ref<{ label: string; value: TextType | '' }[]>([
  { label: t('markup.textTypes.unlabeled'), value: '' },
  { label: t('markup.textTypes.title'), value: 'title' },
  { label: t('markup.textTypes.subtitle'), value: 'subtitle' },
  { label: t('markup.textTypes.body'), value: 'content' },
  { label: t('markup.textTypes.listItem'), value: 'item' },
  { label: t('markup.textTypes.listTitle'), value: 'itemTitle' },
  { label: t('markup.textTypes.note'), value: 'notes' },
  { label: t('markup.textTypes.header'), value: 'header' },
  { label: t('markup.textTypes.footer'), value: 'footer' },
  { label: t('markup.textTypes.sectionNumber'), value: 'partNumber' },
  { label: t('markup.textTypes.itemNumber'), value: 'itemNumber' },
])

const imageTypeOptions = ref<{ label: string; value: ImageType | '' }[]>([
  { label: t('markup.imageTypes.unlabeled'), value: '' },
  { label: t('markup.imageTypes.page'), value: 'pageFigure' },
  { label: t('markup.imageTypes.item'), value: 'itemFigure' },
  { label: t('markup.imageTypes.bg'), value: 'background' },
])

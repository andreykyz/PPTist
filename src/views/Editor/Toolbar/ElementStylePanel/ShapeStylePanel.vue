<template>
  <div class="shape-style-panel">
    <div class="title">
      <span>{{ t('generic.replaceShapeHint') }}</span>
    ...
    <div class="row">
      <Select 
        ...
        :options="[
          { label: t('elStyle.fill.solid'), value: 'fill' },
          { label: t('elStyle.fill.gradient'), value: 'gradient' },
          { label: t('elStyle.fill.pattern'), value: 'pattern' },
        ]"
      />
      ...
      <Select 
        ...
        :options="[
          { label: t('elStyle.fill.linearGradient'), value: 'linear' },
          { label: t('elStyle.fill.radialGradient'), value: 'radial' },
        ]"
      />
    </div>
    ...
    <template v-if="fillType === 'gradient'">
      ...
      <div class="row">
        <div style="width: 40%;">{{ t('generic.currentBlock') }}</div>
      ...
      <div class="row" v-if="gradient.type === 'linear'">
        <div style="width: 40%;">{{ t('generic.gradientAngle') }}</div>
        <Slider
          style="width: 60%;"
          :min="0"
          :max="360"
    ...
    <template v-if="handleShapeElement.text?.content">
      ...
      <div class="row">
        <div style="width: 40%;">{{ t('generic.paragraphSpace') }}</div>
        <Select style="width: 60%;"
      ...
      <div class="row">
        <div style="width: 40%;">{{ t('generic.wordSpace') }}</div>
        <Select style="width: 60%;"
          :value="wordSpace || 0"
      ...
      <div class="row">
        <NumberInput
          ...
          style="width: 45%;"
        >
          <template #prefix>{{ t('generic.topInset') }}</template>
        </NumberInput>
      ...
      <div class="row">
        <NumberInput
          ...
          style="width: 45%;"
        >
          <template #prefix>{{ t('generic.leftInset') }}</template>
        </NumberInput>
        <div style="width: 10%;"></div>
        <NumberInput
          :min="0"
    ...
    <div class="row">
      <CheckboxButton
        v-tooltip="t('generic.shapeDoubleHint')"
        style="flex: 1;"
        :checked="!!shapeFormatPainter"
        @click="toggleShapeFormatPainter()"
        @dblclick="toggleShapeFormatPainter(true)"
      ><i-icon-park-outline:format-brush /> {{ t('generic.shapeFormatPainter') }}</CheckboxButton>
    </div>
  </div>
</template>

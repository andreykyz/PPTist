<template>
  <div class="multi-style-panel">
    <div class="row">
      <div style="width: 40%;">{{ t('generic.fill') }}：</div>
    ...
    <div class="row">
      <div style="width: 40%;">{{ t('generic.style') }}：</div>
    ...
    <div class="row">
      <div style="width: 40%;">{{ t('generic.borderColor') }}：</div>
      <Popover trigger="click" style="width: 60%;">
        <template #content>
          <ColorPicker
    ...
    <ButtonGroup class="row" passive>
      <Popover trigger="click" style="width: 30%;">
        ...
        <TextColorButton first :color="richTextAttrs.color" v-tooltip="t('richText.textColor')">
      ...
      <Popover trigger="click" style="width: 30%;">
        ...
        <TextColorButton :color="richTextAttrs.backcolor" v-tooltip="t('richText.textHighlight')">
    ...
    >
      <RadioButton value="left" style="flex: 1;" v-tooltip="t('richText.alignLeft')"><i-icon-park-outline:align-text-left /></RadioButton>
      <RadioButton value="center" style="flex: 1;" v-tooltip="t('richText.alignCenter')"><i-icon-park-outline:align-text-center /></RadioButton>
      <RadioButton value="right" style="flex: 1;" v-tooltip="t('richText.alignRight')"><i-icon-park-outline:align-text-right /></RadioButton>
      <RadioButton value="justify" style="flex: 1;" v-tooltip="t('richText.alignJustify')"><i-icon-park-outline:align-text-both /></RadioButton>
    </RadioGroup>
  </div>
</template>

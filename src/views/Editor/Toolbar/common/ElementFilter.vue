...
const defaultFilters: FilterOption[] = [
  { label: t('elStyle.filter.blur'), key: 'blur', default: 0, value: 0, unit: 'px', max: 10, step: 1 },
  { label: t('elStyle.filter.brightness'), key: 'brightness', default: 100, value: 100, unit: '%', max: 200, step: 5 },
  { label: t('elStyle.filter.contrast'), key: 'contrast', default: 100, value: 100, unit: '%', max: 200, step: 5 },
  { label: t('elStyle.filter.grayscale'), key: 'grayscale', default: 0, value: 0, unit: '%', max: 100, step: 5 },
  { label: t('elStyle.filter.saturation'), key: 'saturate', default: 100, value: 100, unit: '%', max: 200, step: 5 },
  { label: t('elStyle.filter.hue'), key: 'hue-rotate', default: 0, value: 0, unit: 'deg', max: 360, step: 10 },
  { label: t('elStyle.filter.sepia'), key: 'sepia', default: 0, value: 0, unit: '%', max: 100, step: 5 },
  { label: t('elStyle.filter.invert'), key: 'invert', default: 0, value: 0, unit: '%', max: 100, step: 5 },
  { label: t('elStyle.filter.opacity'), key: 'opacity', default: 100, value: 100, unit: '%', max: 100, step: 5 },
]
...
const presetFilters: {
  ...
  { label: t('elStyle.filter.blackwh'), values: { 'grayscale': '100%' } },
  { label: t('elStyle.filter.vintage'), values: { 'sepia': '50%', 'contrast': '110%', 'brightness': '90%' } },
  { label: t('elStyle.filter.sharpen'), values: { 'contrast': '150%' } },
  { label: t('elStyle.filter.soft'), values: { 'brightness': '110%', 'contrast': '90%' } },
  { label: t('elStyle.filter.warm'), values: { 'sepia': '30%', 'saturate': '135%' } },
  { label: t('elStyle.filter.bright'), values: { 'brightness': '110%', 'contrast': '110%' } },
  { label: t('elStyle.filter.vivid'), values: { 'saturate': '200%' } },
  { label: t('elStyle.filter.blur'), values: { 'blur': '2px' } },
  { label: t('elStyle.filter.invert'), values: { 'invert': '100%' } },
]
